...
buttons to open a file chooser dialog. To set all entries back to the
defaults, click on **Defaults** in the bottom left corner of the window.
As usual, you can stop editing the preferences with the **Cancel** button,
and apply the changes with **OK**. Your changes will be applied after the next
start of **Tanglet**.
